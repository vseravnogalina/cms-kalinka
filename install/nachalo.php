...
if(!file_exists("$admfact/lib/pclzip"))
	...
	copy("pclzip/readme.txt","$admfact/lib/pclzip/readme.txt");}
mkdir("../lib");
if(!file_exists("../lib/pclzip"))
		mkdir("../lib/pclzip");
	if(copy("pclzip/gnu-lgpl.txt","../lib/pclzip/gnu-lgpl.txt"))
	{unlink("pclzip/gnu-lgpl.txt");
	}
	if(copy("pclzip/pclzip.lib.php","../lib/pclzip/pclzip.lib.php"))
	{unlink("pclzip/pclzip.lib.php");
	}
	if(copy("pclzip/readme.txt","../lib/pclzip/readme.txt"))	
...
/*Файл $puttup/images/kalinka_log.png - ../images/kalinka_log.png*/
	if(copy("$puttup/images/logotype.png","../images/logotype.png"))
	unlink("$puttup/images/logotype.png");
if(copy("$puttup/images/CART.png","../images/CART.png"))
	unlink("$puttup/images/CART.png");

	//УДАЛИТЬ папку $puttup/images/
	if (file_exists("../images/logotype.png"))
	{
...
if(copy("$puttup/lib/beforemain.php","../lib/beforemain.php"))
	unlink("$puttup/lib/beforemain.php");	
